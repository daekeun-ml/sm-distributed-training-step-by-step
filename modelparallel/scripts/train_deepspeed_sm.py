...
def setup():
    ...
    os.environ['RANK'] = rank = os.environ['OMPI_COMM_WORLD_RANK']
    os.environ['LOCAL_RANK'] = local_rank = os.environ['OMPI_COMM_WORLD_LOCAL_RANK']
    os.environ['WORLD_SIZE'] = world_size = os.environ['OMPI_COMM_WORLD_SIZE']
...
#         sys.exit("Can't find the evironment variables for local rank")
    ...
    dist.init_process_group(backend="nccl", rank=int(rank), world_size=int(world_size))
